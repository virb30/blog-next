  ...
  return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 203.96 26.36" {...props} role="img" aria-label="logo">
    ...
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        <path className="fill-logo-letters"
        ...
        <path className="fill-logo-letters"
          ...
          transform="translate(-0.25 -2.41)" />
        <polygon className="fill-logo-lower-bracket" points="20 18.18 20 25.09 0 16.56 0 16.55 8.09 13.1 8.1 13.1 20 18.18" />
        <polygon className="fill-logo-upper-bracket" points="20 1.09 20 8.01 8.1 13.09 8.09 13.1 0 9.64 0 9.63 20 1.09" />
        <polygon className="fill-logo-upper-bracket" points="0 9.64 8.09 13.1 0 16.55 0 9.64" />
        <polygon className="fill-logo-lower-bracket"
          points="203.96 9.64 203.96 16.56 183.96 25.09 183.96 18.18 195.86 13.1 203.96 9.64" />
        <polygon className="fill-logo-upper-bracket"
          points="203.96 9.63 203.96 16.55 195.86 13.09 183.96 8.01 183.96 1.09 203.96 9.63" />
        <polygon className="fill-logo-slash" points="182.52 0.2 173.68 26.32 169.58 26.36 175.92 8.64 178.94 0 182.52 0.2" />
      </g>
    </g>
  </svg>)
}