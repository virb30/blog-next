...
export default function Logo({ ...props }) {
  ...
  const cls3 = "#4f46e5";
  const cls4 = useMemo(() => {
    return theme === 'light' ? '#6B7280' : '#D1D5DB';
  }, [theme]);


  return (<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 203.96 26.36" {...props}>
    <title>logo_2</title>
    <g id="Layer_2" data-name="Layer 2">
      <g id="Layer_1-2" data-name="Layer 1">
        ...
        <path fill={cls1}
          ...
          transform="translate(-0.25 -2.41)" />
        <polygon fill={cls2} points="20 18.18 20 25.09 0 16.56 0 16.55 8.09 13.1 8.1 13.1 20 18.18" />
        <polygon fill={cls3} points="20 1.09 20 8.01 8.1 13.09 8.09 13.1 0 9.64 0 9.63 20 1.09" />
        <polygon fill={cls3} points="0 9.64 8.09 13.1 0 16.55 0 9.64" />
        <polygon fill={cls2}
        ...
        <polygon fill={cls4} points="182.52 0.2 173.68 26.32 169.58 26.36 175.92 8.64 178.94 0 182.52 0.2" />
      </g>
    </g>
  </svg>)
}